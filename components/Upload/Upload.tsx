...
const Upload: React.FC<UploadProps> = ({ 
  ...
  const [isUploading, setIsUploading] = useState(false);
    ...
    if (onChange) {
        ...
        file: selectedMedia.file // Make sure to pass the file
        });
    }
    };
  ...
  const handleUploadClick = () => {
    ...
    let fileType: 'Image' | 'Video' | 'Sound' = 'Image';
    ...
    handleMediaSelect({
        name: file.name,
        path: fileUrl,
        file: file, // Make sure this is included
        size: file.size,
        type: fileType
    });
    };
      ...
      >
        {isUploading ? (
          ...
          <>
            ...
            >
                        <svg xmlns="http://www.w3.org/2000/svg" height="70" viewBox="0 0 18 17" fill="none">
