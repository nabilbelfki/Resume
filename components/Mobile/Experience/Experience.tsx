...
const Experience: React.FC<ExperienceProps> = ({
  ...
  const zIndex = hoveredIndex == index ? 1000 : experience.zIndex;
  ...
  return (
    <>
      {index === hoveredIndex && screenWidth <= mobileWidth && (
        <div
          style={{
            position: 'fixed',
            top: 0,
      ...
      >
        <div
          className={index != hoveredIndex ? `${styles.information} ${styles[animationClass]}` : `${styles.information} ${styles[`information-additional-styles`]}`}
          style={{
            backgroundColor: experience.color.background,
            zIndex: zIndex,
            left: direction === "vertical" ? (experience.name == "Cole Solutions LLC" ? 200 : (experience.name === "New Jersey Institute of Technology" ? 30 : 50)) : "50%",
            top: informationTop,
